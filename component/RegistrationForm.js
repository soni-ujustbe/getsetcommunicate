                ...
                error?<div className="error"><p>required</p></div>:null
                    ...
                    <div className="form-row">
                        ...
                        <div className="form-row radio-buttons">
                            <h2>1. Are you confident to speak in Monthly Meeting?<sup>*</sup></h2>
                            <ul>
                        ...
                        {/* 2nd question */}
                        <div className="form-row radio-buttons">
                            <h2>2. Do you think that you understand about the businesses of Listed Partners when they present in Monthly Meeting?<sup>*</sup></h2>
                        ...
                        {/* 3nd question */}
                        <div className="form-row radio-buttons">
                            <h2>3. Which one of the following values is the core value of UJustBe Partner?  <sup>*</sup> </h2>
                            <ul>
                        ...
                        {/* 4th question */}
                        <div className="form-row radio-buttons">
                                <h2>4. As a Partner, which one of the below reasons that you see for yourself to be with UJustBe?<sup>*</sup></h2>
                                <ul>
                                    ...
                                    <li>
                                        <label htmlFor="4A">
                                            <input
                                                ...
                                                checked={fourcheck == 'Referral Fee'} />
                                            <div className='custom_radio'></div>
                                            Referral Fee</label>
                                    </li>
                                    ...
                                    <li>
                                        <label htmlFor="4B">
                                            <input
                                                id="4B"
                                                value="Holistic Personal Development in Relationships, Health and Wealth"
                                                name="questionFour"
                                                type="radio"
                                                onChange={questionFour}
                                                checked={fourcheck == 'Holistic Personal Development in Relationships, Health and Wealth'} />
                                            <div className='custom_radio'></div>
                                            Holistic Personal Development in Relationships, Health and Wealth </label>
                                    </li>
                                    ...
                                    <li>
                                        <label htmlFor="4C">
                                            <input
                                                ...
                                                type="radio"
                                                onChange={questionFour}
                                                checked={fourcheck == 'People Connection'} />
                                            <div className='custom_radio'></div>
                            ...
                            <ul>
                                    ...
                                    <li>
                                        <label htmlFor="5B">
                                            <input
                                                id="5B"
                                                value="Holistic Business Development "
                                                name="questionFive"
                                                type="radio"
                                                onChange={questionFive}
                                                checked={fivecheck == 'Holistic Business Development '} />
                                            <div className='custom_radio'></div>
                                            Holistic Business Development  </label>
                                    </li>
                                    ...
                                    <li>
                                        <label htmlFor="5C">
                                            <input
                                                ...
                                                type="radio"
                                                onChange={questionFive}
                                                checked={fivecheck == 'Collaboration'} />
                                            <div className='custom_radio'></div>
                                            Collaboration</label>
                                    </li>
